...
server {
      ...
      location /loafer-blog {
         alias /apps/loafer-blog/dist;
         index index.html;
         try_files $uri $uri/ /loafer-blog/index.html;
      }

      location /loafer-blog/api {
         proxy_pass http://localhost:8080;
       }

       location /loafer-blog/uploads {
          alias /apps/loafer-blog/uploads;
       }
}
```

**注**：文件访问除了通过 nginx 代理外，还可以通过 Java 的静态资源映射配置来实现 http 访问，适合本地开发环境使用。
